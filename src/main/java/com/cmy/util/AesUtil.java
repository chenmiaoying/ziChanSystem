...
public class AesUtil {
    ...
    public static byte[] base64Decode(String base64Code) throws Exception {
        return StringUtils.isEmptyOrWhitespaceOnly(base64Code) ? null : new BASE64Decoder().decodeBuffer(base64Code);
    }
    ...
    public static String aesDecrypt(String encryptStr, String decryptKey) throws Exception {
        return StringUtils.isEmptyOrWhitespaceOnly(encryptStr) ? null : aesDecryptByBytes(base64Decode(encryptStr), decryptKey);
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        String jsData = aesDecrypt("f02cUxFUe3hVIeG+CdDh5w==", AES_KEY);
